        ...
        <AnimatedSection>
          ...
          <div className="mb-32 flex flex-col items-center gap-20 md:flex-row">
            ...
            <div className="flex flex-col gap-3 md:w-[50%]">
              ...
              >
                {t("cafePage.heroTitle")}
              </h1>
              <p className="text-[16px] text-[#7D858D] md:max-w-[60%]">
                {t("cafePage.heroDescription")}
              </p>
              <Link
                href={`/${locale}/request-demo`}
                // href={"/"}
                className="flex w-fit  cursor-pointer items-center gap-2 rounded-[32px] bg-gradient-to-l from-[#34F3B6] to-[#C6FFED] px-4 py-3 text-[16px] font-bold  text-[#14181C] transition-all duration-300 hover:scale-105"
              >
                {t("cafePage.trySystemButton")}
                {locale === "ar" ? (
                  <Image
                    src="/arrow-icon.svg"
                    width={16}
          ...
          <div className="mb-32 flex flex-col items-center gap-20 md:flex-row">
            ...
            <div className="flex flex-col gap-7 md:w-[50%]">
              <p
                className={` text-[30px] font-bold  ${locale === "ar" ? "md:max-w-[80%] " : ""} md:text-[48px]`}
              >
                {t("cafePage.detailedParagraph3")}
              </p>
              <div className="flex flex-col md:w-[70%]">
                <p className="text-[16px] text-[#7D858D]">
                  {t("cafePage.qualityStatement5")}
                </p>
              </div>
            </div>
          </div>
