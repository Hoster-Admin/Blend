...
// Placeholder imagery reused from the restaurant set until dedicated
// dark-store photography is supplied.
function DarkStoreComponent() {
    ...
    <div className="">
        ...
        <AnimatedSection>
          <div className="mb-32 flex flex-col items-center gap-20 md:flex-row">
            ...
            <div className="flex flex-col gap-3 md:w-[50%]">
              ...
              >
                {t("darkStorePage.heroTitle")}
              </h1>
              <p className="text-[16px] text-[#7D858D] md:max-w-[60%]">
                {t("darkStorePage.heroDescription")}
              </p>
              <Link
          ...
          <div className="mb-32 flex flex-col items-center gap-20 md:flex-row">
            <div className="flex flex-col gap-7 md:w-[50%]">
              <p
                className={` text-[30px] font-bold  ${locale === "ar" ? "md:max-w-[80%] " : ""} md:text-[48px]`}
              >
                {t("darkStorePage.detailedParagraph")}
              </p>
              <div className="flex flex-col">
                <p className="text-[16px]  text-[#7D858D]">
                  {t("darkStorePage.qualityStatement")}
                </p>
                <p className="text-[16px] text-[#7D858D]">
                  {t("darkStorePage.qualityStatement2")}
                </p>
                <p className="mt-4 text-[16px] text-[#7D858D]">
                  {t("darkStorePage.qualityStatement3")}
                </p>
              </div>
            </div>
            <div className="md:w-[50%]">
          ...
          <div className="mb-32 flex flex-col items-center gap-20 md:flex-row">
            ...
            <div className="flex flex-col gap-7 md:w-[50%]">
              <p
                className={` text-[30px] font-bold  ${locale === "ar" ? "md:max-w-[80%] " : ""} md:text-[48px]`}
              >
                {t("darkStorePage.detailedParagraph3")}
              </p>
              <div className="flex flex-col md:w-[70%]">
                <p className="text-[16px] text-[#7D858D]">
                  {t("darkStorePage.qualityStatement5")}
                </p>
              </div>
            </div>
          </div>
      ...
      <AnimatedSection>
        <section className="mx-auto mb-32  max-w-7xl px-5 md:px-10">
          <div className=" flex h-full flex-col items-center justify-between gap-10 rounded-[32px]  bg-gradient-to-l from-[#FF6C02] to-[#FFE5D1] px-5 py-10 md:h-[376px] md:flex-row  md:gap-20  md:px-10  md:py-0 ">
...
export default DarkStoreComponent;
