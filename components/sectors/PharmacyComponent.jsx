...
// Placeholder imagery reused from the retail/supplier set until dedicated
// pharmacy photography is supplied.
    ...
    <div className="">
        ...
        <AnimatedSection>
          <div className="mb-32 flex flex-col items-center gap-20 md:flex-row">
            ...
            <div className="flex flex-col gap-3 md:w-[50%]">
              ...
              >
                {t("pharmacyPage.heroTitle")}
              </h1>
              <p className="text-[16px] text-[#7D858D] md:max-w-[60%]">
                {t("pharmacyPage.heroDescription")}
              </p>
              <Link
          ...
          <div className="mb-32 flex flex-col items-center gap-20 md:flex-row">
            <div className="flex flex-col gap-7 md:w-[50%]">
              <p
                className={` text-[30px] font-bold  ${locale === "ar" ? "md:max-w-[80%] " : ""} md:text-[48px]`}
              >
                {t("pharmacyPage.detailedParagraph")}
              </p>
              <div className="flex flex-col">
                <p className="text-[16px]  text-[#7D858D]">
                  {t("pharmacyPage.qualityStatement")}
                </p>
                <p className="text-[16px] text-[#7D858D]">
                  {t("pharmacyPage.qualityStatement2")}
                </p>
                <p className="mt-4 text-[16px] text-[#7D858D]">
                  {t("pharmacyPage.qualityStatement3")}
                </p>
              </div>
            </div>
            <div className="md:w-[50%]">
          ...
          <div className="mb-32 flex flex-col items-center gap-20 md:flex-row">
            ...
            <div className="flex flex-col gap-7 md:w-[50%]">
              <p
                className={` text-[30px] font-bold  ${locale === "ar" ? "md:max-w-[80%] " : ""} md:text-[48px]`}
              >
                {t("pharmacyPage.detailedParagraph3")}
              </p>
              <div className="flex flex-col md:w-[70%]">
                <p className="text-[16px] text-[#7D858D]">
                  {t("pharmacyPage.qualityStatement5")}
                </p>
              </div>
            </div>
          </div>
      ...
      <AnimatedSection>
        <section className="mx-auto mb-32  max-w-7xl px-5 md:px-10">
          <div className=" flex h-full flex-col items-center justify-between gap-10 rounded-[32px]  bg-gradient-to-l from-[#71B5FE] to-[#CDE7FF] px-5 py-10 md:h-[376px] md:flex-row  md:gap-20  md:px-10  md:py-0 ">
